...
This is a really-minor modification from https://github.com/envimate/nrpe. All credits go to him
*/
package nrpe
...
func readPacket(conn net.Conn, timeout time.Duration, p *packet) error {
	...
	//uery parameters and form values. Unlike in the http.Header map, the keys in a Values map are case-sensitive.
